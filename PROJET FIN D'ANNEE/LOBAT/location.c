...
void ajouterLocation(){
    ...
    do{
        ...
        if(myStrlen(loc.adresse.pays)>19 || verifLetter(loc.adresse.pays)){
            printf("Erreur : Veuillez reessayer\n");
        }
    ...
    do{
        ...
        if(myStrlen(loc.adresse.region)>19 || verifLetter(loc.adresse.region)){
            printf("Erreur : Veuillez reessayer\n");
        }
    ...
    do{
        ...
        if(myStrlen(loc.adresse.departement)>19 || verifLetter(loc.adresse.departement)){
            printf("Erreur : Veuillez reessayer\n");
        }
    ...
    do{
        ...
        if(myStrlen(loc.adresse.commune)>19 || verifLetter(loc.adresse.commune)){
            printf("Erreur : Veuillez reessayer\n");
        }
